	...
	?>
		...
		<nav class="bcd__sidebar--nav">
			<ul class="bcd__sidebar--list">
				<li class="bcd__sidebar--item"><div class="bcd__sidebar--tip">Meu perfil</div><a href="#"><i class="fa-solid fa-circle-user"></i></a></li>
				<li class="bcd__sidebar--item active"><div class="bcd__sidebar--tip">Lista de imóveis</div><a href="#"><i class="fa-solid fa-building"></i></a></li>
				<li class="bcd__sidebar--item"><div class="bcd__sidebar--tip">Novo imóvel</div><a href="#"><i class="fa-solid fa-file-circle-plus"></i></a></li>
				<li class="bcd__sidebar--item"><div class="bcd__sidebar--tip">Favoritos</div><a href="#"><i class="fa-solid fa-heart"></i></a></li>
				<li class="bcd__sidebar--item"><div class="bcd__sidebar--tip">Buscas salvas</div><a href="#"><i class="fa-solid fa-magnifying-glass-location"></i></a></li>
				<li class="bcd__sidebar--item"><div class="bcd__sidebar--tip">Usuários</div><a href="#"><i class="fa-solid fa-users"></i></a></li>
				<li class="bcd__sidebar--item"><div class="bcd__sidebar--tip">Definições</div><a href="#"><i class="fa-solid fa-sliders"></i></a></li>
				<li class="bcd__sidebar--item"><div class="bcd__sidebar--tip">Sair</div><a href="#"><i class="fa-solid fa-right-from-bracket"></i></a></li>
				<li class="bcd__sidebar--item back-to-site"><div class="bcd__sidebar--tip">Voltar para o site</div><a href="#"><i class="fa-solid fa-angles-left"></i></a></li>
			</ul>
	...
	?>
		<main class="bcd__content">
			<section class="bcd__content--title">
				...
				<div class="right">
					<button class="bcd__content--add-new">Novo imóvel</button>
				</div>
			</section>
